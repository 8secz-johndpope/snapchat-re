...
public class Mat {
    ...
    public int get(int i, int i2, byte[] bArr) {
        ...
        if (bArr == null || bArr.length % CvType.channels(type) != 0) {
            StringBuilder stringBuilder = new StringBuilder("Provided data element number (");
            stringBuilder.append(bArr == null ? 0 : bArr.length);
            stringBuilder.append(") should be multiple of the Mat channels count (");
            stringBuilder.append(CvType.channels(type));
    ...
    public int get(int i, int i2, double[] dArr) {
        ...
        if (dArr == null || dArr.length % CvType.channels(type) != 0) {
            StringBuilder stringBuilder = new StringBuilder("Provided data element number (");
            stringBuilder.append(dArr == null ? 0 : dArr.length);
            stringBuilder.append(") should be multiple of the Mat channels count (");
            stringBuilder.append(CvType.channels(type));
            stringBuilder.append(")");
            throw new UnsupportedOperationException(stringBuilder.toString());
    ...
    public int get(int i, int i2, float[] fArr) {
        ...
        if (fArr == null || fArr.length % CvType.channels(type) != 0) {
            StringBuilder stringBuilder = new StringBuilder("Provided data element number (");
            stringBuilder.append(fArr == null ? 0 : fArr.length);
            stringBuilder.append(") should be multiple of the Mat channels count (");
            stringBuilder.append(CvType.channels(type));
            stringBuilder.append(")");
            throw new UnsupportedOperationException(stringBuilder.toString());
    ...
    public int get(int i, int i2, int[] iArr) {
        ...
        if (iArr == null || iArr.length % CvType.channels(type) != 0) {
            StringBuilder stringBuilder = new StringBuilder("Provided data element number (");
            stringBuilder.append(iArr == null ? 0 : iArr.length);
            stringBuilder.append(") should be multiple of the Mat channels count (");
            stringBuilder.append(CvType.channels(type));
            stringBuilder.append(")");
            throw new UnsupportedOperationException(stringBuilder.toString());
    ...
    public int get(int i, int i2, short[] sArr) {
        ...
        if (sArr == null || sArr.length % CvType.channels(type) != 0) {
            StringBuilder stringBuilder = new StringBuilder("Provided data element number (");
            stringBuilder.append(sArr == null ? 0 : sArr.length);
            stringBuilder.append(") should be multiple of the Mat channels count (");
            stringBuilder.append(CvType.channels(type));
            stringBuilder.append(")");
            throw new UnsupportedOperationException(stringBuilder.toString());
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder("Mat [ ");
        stringBuilder.append(rows());
        String str = EventType.ANY;
        stringBuilder.append(str);
        stringBuilder.append(cols());
        stringBuilder.append(str);
        stringBuilder.append(CvType.typeToString(type()));
        stringBuilder.append(", isCont=");
        stringBuilder.append(isContinuous());
        stringBuilder.append(", isSubmat=");
        stringBuilder.append(isSubmatrix());
        stringBuilder.append(", nativeObj=0x");
        stringBuilder.append(Long.toHexString(this.nativeObj));
        stringBuilder.append(", dataAddr=0x");
        stringBuilder.append(Long.toHexString(dataAddr()));
        stringBuilder.append(" ]");
