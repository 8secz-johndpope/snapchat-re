...
public class SampleBoxes extends Boxes {
    public SampleBoxes() {
        ...
        String str2 = "ima4";
        override(str2, org.jcodec.containers.mp4.boxes.AudioSampleEntry.class);
        ...
        override(Platform.stringFromBytes(new byte[]{(byte) 109, (byte) 115, (byte) 0, (byte) 17}), org.jcodec.containers.mp4.boxes.AudioSampleEntry.class);
        override(Platform.stringFromBytes(new byte[]{(byte) 109, (byte) 115, (byte) 0, (byte) 49}), org.jcodec.containers.mp4.boxes.AudioSampleEntry.class);
        ...
        override(str, org.jcodec.containers.mp4.boxes.AudioSampleEntry.class);
        ...
        override(CuePointFields.TIME, TimecodeSampleEntry.class);
