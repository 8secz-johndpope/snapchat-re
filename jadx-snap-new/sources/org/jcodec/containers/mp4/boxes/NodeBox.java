...
public class NodeBox extends Box {
            ...
            if (box2 != null) {
                if (!Platform.isAssignableFrom(cls, box2.getClass())) {
                    try {
                        ...
                        StringBuilder stringBuilder = new StringBuilder("Failed to reinterpret box: ");
                        stringBuilder.append(box2.getFourcc());
    ...
    /* Access modifiers changed, original: protected */
    public void dumpBoxes(StringBuilder stringBuilder) {
