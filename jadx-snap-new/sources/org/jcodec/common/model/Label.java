...
public final class Label {
    public static final Label Ambisonic_W = new Label(Callback.DEFAULT_DRAG_ANIMATION_DURATION);
    ...
    public static final Label Discrete_0 = new Label(Imgproc.FLOODFILL_FIXED_RANGE);
