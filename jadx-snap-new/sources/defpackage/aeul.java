...
/* renamed from: aeul */
public final class aeul extends TypeAdapter<aeuk> {
    private final Gson a;

    public aeul(Gson gson) {
        this.a = gson;
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:24:0x0059  */
    /* renamed from: a */
    public final defpackage.aeuk read(com.google.gson.stream.JsonReader r8) {
        /*
        r7 = this;
        r0 = r8.peek();
    ...
    L_0x00be:
        ...
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aeul.read(com.google.gson.stream.JsonReader):aeuk");
    }

    /* renamed from: a */
    public final void write(JsonWriter jsonWriter, aeuk aeuk) {
        if (aeuk == null) {
        ...
        if (aeuk.o != null) {
            ...
            jsonWriter.value(aeuk.o);
        }
        if (aeuk.p != null) {
            jsonWriter.name("id");
            jsonWriter.value(aeuk.p);
        }
        if (aeuk.q != null) {
            jsonWriter.name("app_engine_target");
            jsonWriter.value(aeuk.q);
        }
