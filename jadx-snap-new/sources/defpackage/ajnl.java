...
/* renamed from: ajnl */
public final class ajnl<T, R> extends ajdp<R> {
    private ajdp<T> a;
    ...
    static final class a<T, R> extends AtomicInteger implements ajdv<T>, ajej {
        ...
        private ajfc<? super T, ? extends ajdn<? extends R>> f;
        private volatile boolean h;
        private volatile boolean i;

        /* renamed from: ajnl$a$a */
        ...
        public final void a(T t) {
            ...
            try {
                ajdn ajdn = (ajdn) ajfv.a(this.f.apply(t), "The mapper returned a null MaybeSource");
                a aVar = new a(this);
                a aVar2;
                do {
                    aVar2 = (a) this.c.get();
    ...
    public ajnl(ajdp<T> ajdp, ajfc<? super T, ? extends ajdn<? extends R>> ajfc) {
        this.a = ajdp;
        this.b = ajfc;
    }
