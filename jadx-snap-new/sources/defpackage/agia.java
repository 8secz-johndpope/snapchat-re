...
/* renamed from: agia */
public enum agia {
    AUTH_TOKEN_EXPIRED(r2),
    AUTH_TOKEN_INVALID(r3),
    AUTH_TOKEN_REVOKED(r4),
    BAD_REQUEST(r5),
    BILLING_ADDRESS_INVALID(r6),
    BILLING_CITY_INVALID(r7),
    BILLING_COUNTRY_INVALID(r8),
    BILLING_NAME_INVALID(r8),
    ...
    private agia(String str) {
        this.value = str;
    }

    public static agia a(String str) {
        if (str == null) {
            return UNRECOGNIZED_VALUE;
        }
        try {
            return agia.valueOf(str.toUpperCase(Locale.US));
