...
/* renamed from: ajoz */
public final class ajoz<T, R> extends ajnp<T, R> {
    ...
    static final class a<T, R> extends AtomicInteger implements ajdv<T>, ajej {
        ...
        ajej g;
        private ajfc<? super T, ? extends ajdn<? extends R>> h;
        private volatile boolean i;

        /* renamed from: ajoz$a$a */
        final class a extends AtomicReference<ajej> implements ajdl<R>, ajej {
            a() {
            }
            ...
            public final void a() {
                ...
                if (aVar.get() == 0) {
                    ...
                    if (aVar.compareAndSet(0, 1)) {
                        ...
                        ajtb ajtb = (ajtb) aVar.f.get();
                        if (i == 0 || !(ajtb == null || ajtb.isEmpty())) {
                            if (aVar.decrementAndGet() != 0) {
                                aVar.c();
                                return;
                            }
                        }
                        Throwable a = ajur.a(aVar.e);
                        if (a != null) {
                            aVar.a.a(a);
                            return;
                        } else {
            ...
            public final void b_(R r5) {
                ...
                return;
                */
                throw new UnsupportedOperationException("Method not decompiled: defpackage.ajoz$a$a.b_(java.lang.Object):void");
            }
        ...
        a(ajdv<? super R> ajdv, ajfc<? super T, ? extends ajdn<? extends R>> ajfc, boolean z) {
            this.a = ajdv;
            this.h = ajfc;
            this.b = z;
        }
        ...
        public final void a(T t) {
            try {
                ajdn ajdn = (ajdn) ajfv.a(this.h.apply(t), "The mapper returned a null MaybeSource");
    ...
    public ajoz(ajdt<T> ajdt, ajfc<? super T, ? extends ajdn<? extends R>> ajfc) {
        super(ajdt);
        this.b = ajfc;
    }
