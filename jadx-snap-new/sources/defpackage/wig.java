...
/* renamed from: wig */
public final class wig extends saa implements akhn {
    private final ajxe a;
    private final ajxe b;

    /* renamed from: wig$b */
    static final class b extends akcs implements akbk<iha> {
    ...
    /* renamed from: wig$a */
    static final class a extends akcs implements akbk<wiw> {
        ...
        public final /* synthetic */ Object invoke() {
            return (wiw) this.a.get();
        }
    }

    static {
        aken[] akenArr = new aken[]{new akdc(akde.a(wig.class), "serializationHelper", "getSerializationHelper()Lcom/snap/framework/serialization/SerializationHelper;"), new akdc(akde.a(wig.class), "defaultSnapTokenManager", "getDefaultSnapTokenManager()Lcom/snap/security/snaptoken/DefaultSnapTokenManager;")};
    }

    public wig(aipn<iha> aipn, ajwy<wiw> ajwy) {
        akcr.b(aipn, "_serializationHelper");
        akcr.b(ajwy, "_defaultSnapTokenManager");
    ...
    private final void a(String str) {
        try {
            ...
            String str2 = null;
            if ((afnt != null ? afnt.c : null) != null) {
                if ((afnt != null ? afnt.d : null) != null) {
                    Optional a = wjd.a(afnt != null ? afnt.c : null);
                    if (a != null && a.isPresent()) {
                        wiw b = b();
                        if (afnt != null) {
                            str2 = afnt.d;
                        }
                        akcr.a((Object) str2, "response?.snapTokenToClear");
                        Object obj = a.get();
                        akcr.a(obj, "scopeId.get()");
                        b.a(str2, (wjd) obj);
                    }
                }
            }
    ...
    L_0x00a4:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wig.a(saq, sab):void");
    }
    ...
    L_0x008a:
        ...
        goto L_0x0086;
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wig.intercept(akhn$a):akhv");
    }
}
