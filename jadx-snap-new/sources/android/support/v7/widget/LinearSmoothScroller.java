...
public class LinearSmoothScroller extends SmoothScroller {
    ...
    public int getHorizontalSnapPreference() {
        ...
        return (pointF == null || pointF.x == MapboxConstants.MINIMUM_ZOOM) ? 0 : this.mTargetVector.x > MapboxConstants.MINIMUM_ZOOM ? 1 : -1;
    }

    /* Access modifiers changed, original: protected */
    public int getVerticalSnapPreference() {
        PointF pointF = this.mTargetVector;
        return (pointF == null || pointF.y == MapboxConstants.MINIMUM_ZOOM) ? 0 : this.mTargetVector.y > MapboxConstants.MINIMUM_ZOOM ? 1 : -1;
    }
    ...
    public void updateActionForInterimTarget(Action action) {
        ...
        if (computeScrollVectorForPosition == null || (computeScrollVectorForPosition.x == MapboxConstants.MINIMUM_ZOOM && computeScrollVectorForPosition.y == MapboxConstants.MINIMUM_ZOOM)) {
