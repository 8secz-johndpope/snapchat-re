...
import defpackage.ng.a;

public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, jv {
    ...
    private final jx mParentHelper;
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRemoveActionBarHideOffset = new Runnable() {
            public final void run() {
                ...
                ActionBarOverlayLayout actionBarOverlayLayout = ActionBarOverlayLayout.this;
                actionBarOverlayLayout.mCurrentActionBarTopAnimator = actionBarOverlayLayout.mActionBarTop.animate().translationY(MapboxConstants.MINIMUM_ZOOM).setListener(ActionBarOverlayLayout.this.mTopAnimatorListener);
            }
        };
        ...
        init(context);
        this.mParentHelper = new jx(this);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        Object obj = (kb.a.m(this) & 256) != 0 ? 1 : null;
        if (obj != null) {
        ...
        i3 = View.combineMeasuredStates(combineMeasuredStates, this.mContent.getMeasuredState());
    ...
    public void setMenu(Menu menu, a aVar) {
        pullChildren();
