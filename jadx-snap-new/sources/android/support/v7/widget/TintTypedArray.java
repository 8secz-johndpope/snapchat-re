...
public class TintTypedArray {
    ...
    public ColorStateList getColorStateList(int i) {
        if (this.mWrapped.hasValue(i)) {
            ...
            if (resourceId != 0) {
                ColorStateList a = ma.a(this.mContext, resourceId);
                if (a != null) {
                    return a;
                }
            }
    ...
    public Drawable getDrawable(int i) {
        if (this.mWrapped.hasValue(i)) {
            int resourceId = this.mWrapped.getResourceId(i, 0);
            if (resourceId != 0) {
                return ma.b(this.mContext, resourceId);
            }
        }
    ...
    public Typeface getFont(int i, int i2, a aVar) {
        int resourceId = this.mWrapped.getResourceId(i, 0);
        if (resourceId == 0) {
            return null;
        }
        ...
        return context.isRestricted() ? null : hh.a(context, resourceId, this.mTypedValue, i2, aVar, true);
    }
