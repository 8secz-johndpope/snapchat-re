...
public class TintContextWrapper extends ContextWrapper {
    ...
    private TintContextWrapper(Context context) {
        ...
        this.mResources = new ou(this, context.getResources());
        this.mTheme = null;
    }

    private static boolean shouldWrap(Context context) {
        return ((context instanceof TintContextWrapper) || (context.getResources() instanceof ou) || (context.getResources() instanceof VectorEnabledTintResources)) ? false : VERSION.SDK_INT < 21 || VectorEnabledTintResources.shouldBeUsed();
    }
