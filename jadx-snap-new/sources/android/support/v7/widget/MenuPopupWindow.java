...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class MenuDropDownListView extends oh {
            ...
            if (this.mHoverListener != null) {
                ...
                if (motionEvent.getAction() != 10) {
                    ...
                    if (pointToPosition != -1) {
                        ...
                        if (pointToPosition >= 0 && pointToPosition < myVar.getCount()) {
                            menuItem = myVar.getItem(pointToPosition);
                        }
                    }
                }
                ...
                if (menuItem2 != menuItem) {
                    mz mzVar = myVar.a;
                    if (menuItem2 != null) {
                        this.mHoverListener.onItemHoverExit(mzVar, menuItem2);
                    }
                    this.mHoveredMenuItem = menuItem;
                    if (menuItem != null) {
                        this.mHoverListener.onItemHoverEnter(mzVar, menuItem);
                    }
                }
            }
    ...
    public void onItemHoverEnter(mz mzVar, MenuItem menuItem) {
        MenuItemHoverListener menuItemHoverListener = this.mHoverListener;
        if (menuItemHoverListener != null) {
            menuItemHoverListener.onItemHoverEnter(mzVar, menuItem);
        }
    }

    public void onItemHoverExit(mz mzVar, MenuItem menuItem) {
        MenuItemHoverListener menuItemHoverListener = this.mHoverListener;
        if (menuItemHoverListener != null) {
            menuItemHoverListener.onItemHoverExit(mzVar, menuItem);
        }
    }
