...
public class RecyclerView extends ViewGroup implements jt {
    ...
    public nr mAdapterHelper;
    boolean mAdapterUpdateDuringMeasure;
    private EdgeEffect mBottomGlow;
    private ChildDrawingOrderCallback mChildDrawingOrderCallback;
    public og mChildHelper;
    ...
    public defpackage.oj.a mPrefetchRegistry;
    ...
    private ju mScrollingChildHelper;
    ...
    private final defpackage.ox.b mViewInfoProcessCallback;
    final ox mViewInfoStore;
    ...
    public static abstract class LayoutManager {
        ...
        private final b mHorizontalBoundCheckCallback = new b() {
            public final int a() {
        ...
        private final b mVerticalBoundCheckCallback = new b() {
            public final int a() {
        ...
        /* JADX WARNING: Missing block: B:6:0x0017, code skipped:
            if (r5 == com.looksery.sdk.audio.AudioPlayer.INFINITY_LOOP_COUNT) goto L_0x0021;
     */
        ...
        L_0x002e:
            r7 = 0;
        L_0x002f:
            r4 = android.view.View.MeasureSpec.makeMeasureSpec(r7, r6);
            return r4;
            */
     ...
     */
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.md.a.a, i, i2);
        ...
        private static boolean isMeasurementUpToDate(int i, int i2, int i3) {
            ...
            return (i3 <= 0 || i == i3) ? mode != Integer.MIN_VALUE ? mode != 0 ? mode == AudioPlayer.INFINITY_LOOP_COUNT && i2 == i : true : i2 >= i : false;
        }
        ...
        public View findContainingItemView(View view) {
            ...
            return (view == null || this.mChildHelper.d(view)) ? null : view;
        }
        ...
        public View getChildAt(int i) {
            og ogVar = this.mChildHelper;
            return ogVar != null ? ogVar.b(i) : null;
        }
        ...
        public int getColumnCountForAccessibility(Recycler recycler, State state) {
            RecyclerView recyclerView = this.mRecyclerView;
            return (recyclerView == null || recyclerView.mAdapter == null || !canScrollHorizontally()) ? 1 : this.mRecyclerView.mAdapter.getItemCount();
        }
        ...
        public View getFocusedChild() {
            ...
            View focusedChild = recyclerView.getFocusedChild();
            return (focusedChild == null || this.mChildHelper.d(focusedChild)) ? null : focusedChild;
        }
        ...
        public int getLayoutDirection() {
            return kb.a.j(this.mRecyclerView);
        }
        ...
        public int getMinimumHeight() {
            return kb.a.f(this.mRecyclerView);
        }

        public int getMinimumWidth() {
            return kb.a.e(this.mRecyclerView);
        }
        ...
        public int getPaddingEnd() {
            RecyclerView recyclerView = this.mRecyclerView;
            return recyclerView != null ? kb.a.l(recyclerView) : 0;
        }
        ...
        public int getPaddingStart() {
            RecyclerView recyclerView = this.mRecyclerView;
            return recyclerView != null ? kb.a.k(recyclerView) : 0;
        }
        ...
        public int getRowCountForAccessibility(Recycler recycler, State state) {
            RecyclerView recyclerView = this.mRecyclerView;
            return (recyclerView == null || recyclerView.mAdapter == null || !canScrollVertically()) ? 1 : this.mRecyclerView.mAdapter.getItemCount();
        }
        ...
        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, kk kkVar) {
            ...
            boolean isLayoutHierarchical = isLayoutHierarchical(recycler, state);
            defpackage.kk.a aVar = VERSION.SDK_INT >= 21 ? new defpackage.kk.a(CollectionInfo.obtain(rowCountForAccessibility, columnCountForAccessibility, isLayoutHierarchical, getSelectionModeForAccessibility(recycler, state))) : VERSION.SDK_INT >= 19 ? new defpackage.kk.a(CollectionInfo.obtain(rowCountForAccessibility, columnCountForAccessibility, isLayoutHierarchical)) : new defpackage.kk.a(null);
            if (VERSION.SDK_INT >= 19) {
                kkVar.a.setCollectionInfo((CollectionInfo) aVar.a);
            }
        }

        /* Access modifiers changed, original: 0000 */
        public void onInitializeAccessibilityNodeInfo(kk kkVar) {
            onInitializeAccessibilityNodeInfo(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, kkVar);
        }

        public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, kk kkVar) {
            kkVar.a(defpackage.kk.b.a(canScrollVertically() ? getPosition(view) : 0, 1, canScrollHorizontally() ? getPosition(view) : 0, 1, false));
        }

        /* Access modifiers changed, original: 0000 */
        public void onInitializeAccessibilityNodeInfoForItem(View view, kk kkVar) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt != null && !childViewHolderInt.isRemoved() && !this.mChildHelper.d(childViewHolderInt.itemView)) {
                onInitializeAccessibilityNodeInfoForItem(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, view, kkVar);
            }
        }
        ...
        public void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), AudioPlayer.INFINITY_LOOP_COUNT), MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), AudioPlayer.INFINITY_LOOP_COUNT));
        }
        ...
        public void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mHeight = i;
            this.mWidthMode = AudioPlayer.INFINITY_LOOP_COUNT;
            this.mHeightMode = AudioPlayer.INFINITY_LOOP_COUNT;
        }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH vh, int i) {
            ...
            vh.setFlags(1, 519);
            in.a(RecyclerView.TRACE_BIND_VIEW_TAG);
        ...
        public final VH createViewHolder(ViewGroup viewGroup, int i) {
            try {
                in.a(RecyclerView.TRACE_CREATE_VIEW_TAG);
    ...
    public final class Recycler {
        ...
        private void attachAccessibilityDelegateOnBind(ViewHolder viewHolder) {
            if (RecyclerView.this.isAccessibilityEnabled()) {
                ...
                if (!j.A(view)) {
                    ...
                    j.a(view, RecyclerView.this.mAccessibilityDelegate.getItemDelegate());
                }
            }
        }
        ...
        /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
            jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:24:0x00ad in {8, 9, 12, 13, 16, 17, 19, 21, 23} preds:[]
        ...
        public final void bindViewToPosition(android.view.View r7, int r8) {
            /*
            r6 = this;
            r7 = android.support.v7.widget.RecyclerView.getChildViewHolderInt(r7);
            ...
            r8 = r8.generateDefaultLayoutParams();
            r8 = (android.support.v7.widget.RecyclerView.LayoutParams) r8;
            r0 = r7.itemView;
            r0.setLayoutParams(r8);
            goto L_0x004c;
            r0 = android.support.v7.widget.RecyclerView.this;
            r0 = r0.checkLayoutParams(r8);
            if (r0 != 0) goto L_0x004a;
            r0 = android.support.v7.widget.RecyclerView.this;
            r8 = r0.generateLayoutParams(r8);
            goto L_0x0033;
            r8 = (android.support.v7.widget.RecyclerView.LayoutParams) r8;
            r0 = 1;
            r8.mInsetsDirty = r0;
            ...
            r1 = "Inconsistency detected. Invalid item position ";
            r0.<init>(r1);
            r0.append(r8);
            r8 = "(offset:";
            r0.append(r8);
            ...
            r0 = "The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter";
            r8.<init>(r0);
            r0 = android.support.v7.widget.RecyclerView.this;
            ...
            if (arrayList != null) {
                ...
                if (size != 0) {
                    ...
                    if (RecyclerView.this.mAdapter.hasStableIds()) {
                        i = RecyclerView.this.mAdapterHelper.a(i, 0);
        ...
        public final ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            if (!z) {
                View view;
                og ogVar = RecyclerView.this.mChildHelper;
                int size2 = ogVar.c.size();
                for (int i4 = 0; i4 < size2; i4++) {
                    view = (View) ogVar.c.get(i4);
                    ViewHolder b = ogVar.a.b(view);
                ...
                if (view != null) {
                    ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
                    og ogVar2 = RecyclerView.this.mChildHelper;
                    size = ogVar2.a.a(view);
                    if (size < 0) {
                        throw new IllegalArgumentException("view is not a child, cannot hide ".concat(String.valueOf(view)));
                    } else if (ogVar2.b.c(size)) {
                        ogVar2.b.b(size);
                        ogVar2.b(view);
        ...
        /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
            jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:59:0x0115 in {4, 14, 15, 19, 20, 28, 38, 39, 40, 41, 43, 48, 49, 51, 53, 56, 58} preds:[]
            	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.computeDominators(BlockProcessor.java:242)
            	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.processBlocksTree(BlockProcessor.java:52)
            	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.visit(BlockProcessor.java:42)
            	at jadx.core.dex.visitors.DepthTraversal.visit(DepthTraversal.java:27)
        ...
        /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
            jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:111:0x0259 in {8, 9, 10, 19, 22, 23, 24, 25, 35, 45, 47, 49, 55, 61, 66, 67, 69, 70, 79, 84, 91, 92, 93, 96, 97, 100, 101, 105, 106, 108, 110} preds:[]
            	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.computeDominators(BlockProcessor.java:242)
            	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.processBlocksTree(BlockProcessor.java:52)
            	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.visit(BlockProcessor.java:42)
            	at jadx.core.dex.visitors.DepthTraversal.visit(DepthTraversal.java:27)
    ...
    public static class RecycledViewPool {
        ...
        private a getScrapDataForType(int i) {
            a aVar = (a) this.mScrap.get(i);
            if (aVar != null) {
                return aVar;
            }
            aVar = new a();
            this.mScrap.put(i, aVar);
            return aVar;
        }
        ...
        public void putRecycledView(ViewHolder viewHolder) {
            ...
            if (((a) this.mScrap.get(itemViewType)).b > arrayList.size()) {
        ...
        public int size() {
            ...
            for (int i2 = 0; i2 < this.mScrap.size(); i2++) {
                i += ((a) this.mScrap.valueAt(i2)).a.size();
            }
            return i;
        }
    ...
    class c extends AdapterDataObserver {
        c() {
        }
        ...
        private void a() {
            if (RecyclerView.POST_UPDATES_ON_ANIMATION && RecyclerView.this.mHasFixedSize && RecyclerView.this.mIsAttached) {
                ...
                kb.a(view, view.mUpdateChildViewsRunnable);
                return;
            }
     ...
     */
        ...
        L_0x002b:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.RecyclerView$c.onItemRangeChanged(int, int, java.lang.Object):void");
        }

        /* JADX WARNING: Missing block: B:3:0x0021, code skipped:
            if (r0.a.size() == 1) goto L_0x0025;
     */
        ...
        L_0x002a:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.RecyclerView$c.onItemRangeInserted(int, int):void");
        }

        /* JADX WARNING: Missing block: B:4:0x0025, code skipped:
            if (r0.a.size() == 1) goto L_0x0031;
     */
        ...
        L_0x0028:
            ...
            r6 = "Moving more than 1 item is not supported yet";
            r5.<init>(r6);
            throw r5;
        L_0x0030:
            r2 = 0;
        ...
        L_0x0036:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.RecyclerView$c.onItemRangeMoved(int, int, int):void");
        }
     ...
     */
        ...
        L_0x002b:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.RecyclerView$c.onItemRangeRemoved(int, int):void");
        }
    }
    ...
    class d implements Runnable {
        ...
        public final void a() {
            ...
            kb.a(RecyclerView.this, (Runnable) this);
        }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:56:0x0139  */
        /* JADX WARNING: Missing block: B:52:0x012d, code skipped:
     ...
     */
        ...
        L_0x000c:
            ...
            r4 = android.support.v7.widget.RecyclerView.this;
            r4 = r4.mLayout;
            r4 = r4.mSmoothScroller;
            r5 = r3.computeScrollOffset();
            if (r5 == 0) goto L_0x01d5;
        L_0x0025:
            r5 = android.support.v7.widget.RecyclerView.this;
            r5 = r5.mScrollConsumed;
            r12 = r3.getCurrX();
            r13 = r3.getCurrY();
            r6 = r0.a;
            r14 = r12 - r6;
            ...
            r8 = r15;
            r9 = r5;
            r6 = r6.dispatchNestedPreScroll(r7, r8, r9, r10, r11);
        ...
        L_0x0058:
            ...
            r5 = android.support.v7.widget.RecyclerView.this;
            r6 = r5.mState;
            r5.fillRemainingScrollValues(r6);
        ...
        L_0x0070:
            ...
            r7 = android.support.v7.widget.RecyclerView.this;
            r7 = r7.mState;
            r5 = r5.scrollHorizontallyBy(r14, r6, r7);
            r6 = r14 - r5;
            goto L_0x0085;
        L_0x0083:
            r5 = 0;
        ...
        L_0x0087:
            ...
            r9 = android.support.v7.widget.RecyclerView.this;
            r9 = r9.mState;
            r7 = r7.scrollVerticallyBy(r15, r8, r9);
            r8 = r15 - r7;
            goto L_0x009c;
        L_0x009a:
            r7 = 0;
        ...
        L_0x009c:
            ...
            r9 = android.support.v7.widget.RecyclerView.this;
            r9.stopInterceptRequestLayout(r1);
            if (r4 == 0) goto L_0x00e0;
        L_0x00b0:
            r9 = r4.isPendingInitialRun();
        ...
        L_0x00fd:
            ...
            r19 = r6;
            r20 = r8;
            r9 = r16.dispatchNestedScroll(r17, r18, r19, r20, r21, r22);
        ...
        L_0x0131:
            r1 = android.support.v7.widget.RecyclerView.this;
            r1 = r1.getOverScrollMode();
            if (r1 == r10) goto L_0x013e;
        L_0x0139:
            r1 = android.support.v7.widget.RecyclerView.this;
            r1.absorbGlows(r11, r9);
        L_0x013e:
        ...
        L_0x0159:
            r1 = android.support.v7.widget.RecyclerView.this;
            r1.dispatchOnScrolled(r5, r7);
        L_0x015e:
            r1 = android.support.v7.widget.RecyclerView.this;
            r1 = r1.awakenScrollBars();
        ...
        L_0x017e:
            r6 = android.support.v7.widget.RecyclerView.this;
            r6 = r6.mLayout;
            r6 = r6.canScrollHorizontally();
            if (r6 == 0) goto L_0x018c;
        L_0x0188:
            if (r5 != r14) goto L_0x018c;
        L_0x018a:
            r5 = 1;
            goto L_0x018d;
        L_0x018c:
        ...
        L_0x01a1:
            r1 = android.support.v7.widget.RecyclerView.this;
            r1 = r1.hasNestedScrollingParent(r2);
            if (r1 != 0) goto L_0x01aa;
        L_0x01a9:
            goto L_0x01bd;
        L_0x01aa:
        ...
        L_0x01d7:
            r1 = r4.isPendingInitialRun();
            if (r1 == 0) goto L_0x01e2;
        L_0x01dd:
            r1 = 0;
            r4.onAnimation(r1, r1);
            goto L_0x01e3;
        L_0x01e2:
            r1 = 0;
        L_0x01e3:
                ...
                if (i >= 0) {
                    ...
                    if (this.mInterpolator == null) {
                        ...
                        if (this.mDuration == Integer.MIN_VALUE) {
                            dVar = recyclerView.mViewFlinger;
                            i = this.mDx;
                            i2 = this.mDy;
                            a = dVar.a(i, i2);
                        } else {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mPrefetchRegistry = ALLOW_THREAD_GAP_WORK ? new defpackage.oj.a() : null;
        ...
        this.mViewInfoProcessCallback = new defpackage.ox.b() {
            public final void a(ViewHolder viewHolder) {
                RecyclerView.this.mLayout.removeAndRecycleView(viewHolder.itemView, RecyclerView.this.mRecycler);
            }

            public final void a(ViewHolder viewHolder, ItemHolderInfo itemHolderInfo, ItemHolderInfo itemHolderInfo2) {
            ...
            public final void c(ViewHolder viewHolder, ItemHolderInfo itemHolderInfo, ItemHolderInfo itemHolderInfo2) {
        ...
        this.mScaledHorizontalScrollFactor = VERSION.SDK_INT >= 26 ? viewConfiguration.getScaledHorizontalScrollFactor() : kc.a(viewConfiguration, context);
        this.mScaledVerticalScrollFactor = VERSION.SDK_INT >= 26 ? viewConfiguration.getScaledVerticalScrollFactor() : kc.a(viewConfiguration, context);
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, defpackage.md.a.a, i, 0);
    ...
    private void dispatchLayoutStep1() {
        ...
        boolean z = state.mRunSimpleAnimations && this.mItemsChanged;
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (a = 0; a < this.mChildHelper.a(); a++) {
                ...
                if (!childViewHolderInt.shouldIgnore()) {
                    defpackage.ox.a aVar = (defpackage.ox.a) this.mViewInfoStore.a.get(childViewHolderInt);
                    Object obj = (aVar == null || (aVar.a & 4) == 0) ? null : 1;
                    if (obj == null) {
                        int buildAdapterChangeFlagsForAnimations = ItemAnimator.buildAdapterChangeFlagsForAnimations(childViewHolderInt);
                        boolean hasAnyOfTheFlags = childViewHolderInt.hasAnyOfTheFlags(8192);
                        if (!hasAnyOfTheFlags) {
                            buildAdapterChangeFlagsForAnimations |= 4096;
                        }
                        ItemHolderInfo recordPreLayoutInformation = this.mItemAnimator.recordPreLayoutInformation(this.mState, childViewHolderInt, buildAdapterChangeFlagsForAnimations, childViewHolderInt.getUnmodifiedPayloads());
                        if (hasAnyOfTheFlags) {
                            recordAnimationInfoIfBouncedHiddenView(childViewHolderInt, recordPreLayoutInformation);
                        } else {
                            ox oxVar = this.mViewInfoStore;
                            defpackage.ox.a aVar2 = (defpackage.ox.a) oxVar.a.get(childViewHolderInt);
                            if (aVar2 == null) {
                                aVar2 = defpackage.ox.a.a();
                                oxVar.a.put(childViewHolderInt, aVar2);
                            }
                            aVar2.a |= 2;
    ...
    private void dispatchLayoutStep3() {
        ...
        if (state.mRunSimpleAnimations) {
            ...
            for (int a2 = this.mChildHelper.a() - 1; a2 >= 0; a2--) {
                ViewHolder childViewHolderInt = getChildViewHolderInt(this.mChildHelper.b(a2));
                if (!childViewHolderInt.shouldIgnore()) {
                    ...
                    ViewHolder viewHolder = (ViewHolder) this.mViewInfoStore.b.b(changedHolderKey);
                    if (!(viewHolder == null || viewHolder.shouldIgnore())) {
                        ...
                        if (!(a3 && viewHolder == childViewHolderInt)) {
                            a = this.mViewInfoStore.a(viewHolder, 4);
                            this.mViewInfoStore.b(childViewHolderInt, recordPostLayoutInformation);
                            ItemHolderInfo a5 = this.mViewInfoStore.a(childViewHolderInt, 8);
                            if (a == null) {
                                handleMissingPreInfoForChangeError(changedHolderKey, childViewHolderInt, viewHolder);
                            } else {
                                animateChange(viewHolder, childViewHolderInt, a, a5, a3, a4);
                            }
                        }
                    }
                    this.mViewInfoStore.b(childViewHolderInt, recordPostLayoutInformation);
            ...
            ox oxVar = this.mViewInfoStore;
            defpackage.ox.b bVar = this.mViewInfoProcessCallback;
            for (int size = oxVar.a.size() - 1; size >= 0; size--) {
                ViewHolder viewHolder2 = (ViewHolder) oxVar.a.b(size);
                defpackage.ox.a aVar = (defpackage.ox.a) oxVar.a.d(size);
                if ((aVar.a & 3) != 3) {
                    ItemHolderInfo itemHolderInfo;
                    if ((aVar.a & 1) == 0) {
                        if ((aVar.a & 14) != 14) {
                            if ((aVar.a & 12) == 12) {
                                bVar.c(viewHolder2, aVar.b, aVar.c);
                            } else if ((aVar.a & 4) != 0) {
                                itemHolderInfo = aVar.b;
                                a = null;
                            } else if ((aVar.a & 8) == 0) {
                            }
                            defpackage.ox.a.a(aVar);
                        }
                        bVar.b(viewHolder2, aVar.b, aVar.c);
                        defpackage.ox.a.a(aVar);
                    } else if (aVar.b != null) {
                        itemHolderInfo = aVar.b;
                        a = aVar.c;
                    }
                    bVar.a(viewHolder2, itemHolderInfo, a);
                    defpackage.ox.a.a(aVar);
                }
                bVar.a(viewHolder2);
                defpackage.ox.a.a(aVar);
    ...
    private ju getScrollingChildHelper() {
        if (this.mScrollingChildHelper == null) {
            this.mScrollingChildHelper = new ju(this);
        }
    ...
    private void handleMissingPreInfoForChangeError(long j, ViewHolder viewHolder, ViewHolder viewHolder2) {
        ...
        StringBuilder stringBuilder2 = new StringBuilder("Problem while matching changed view holders with the newones. The pre-layout information for the change holder ");
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new og(new defpackage.og.b() {
            public final int a() {
    ...
    /* JADX WARNING: Missing block: B:82:0x011e, code skipped:
            return false;
     */
    ...
    public void consumePendingUpdateOperations() {
        ...
        if (!z || this.mDataSetHasChangedAfterLayout) {
            ...
            in.a(TRACE_HANDLE_ADAPTER_UPDATES_TAG);
            startInterceptRequestLayout();
            onEnterLayoutOrScroll();
            this.mAdapterHelper.b();
    ...
    public void defaultOnMeasure(int i, int i2) {
        setMeasuredDimension(LayoutManager.chooseSize(i, getPaddingLeft() + getPaddingRight(), kb.a.e(this)), LayoutManager.chooseSize(i2, getPaddingTop() + getPaddingBottom(), kb.a.f(this)));
    }
    ...
    public void dispatchLayout() {
        ...
        if (adapter == null) {
            ...
            if (state.mLayoutStep == 1) {
                ...
                nr nrVar = this.mAdapterHelper;
                if (!(nrVar.b.isEmpty() || nrVar.a.isEmpty())) {
                    z = true;
                }
    ...
    public void draw(Canvas canvas) {
        ...
        if (edgeEffect2 == null || edgeEffect2.isFinished()) {
            ...
            canvas.translate((float) ((-getHeight()) + i), MapboxConstants.MINIMUM_ZOOM);
        ...
        if (!(edgeEffect2 == null || edgeEffect2.isFinished())) {
            size = canvas.save();
            i2 = getWidth();
            paddingTop = this.mClipToPadding ? getPaddingTop() : 0;
            canvas.rotate(90.0f);
        ...
        if (layoutManager == null) {
            ...
            if (!dispatchNestedPreFling(f, f2)) {
                ...
                if (z) {
                    ...
                    canScrollHorizontally = this.mMaxFlingVelocity;
                    ...
                    d dVar = this.mViewFlinger;
                    RecyclerView.this.setScrollState(2);
                    dVar.b = 0;
                    dVar.a = 0;
                    dVar.c.fling(0, 0, max, max2, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
                    dVar.a();
                    return true;
                }
            }
    ...
    public int getAdapterPositionFor(ViewHolder viewHolder) {
        ...
        int size = nrVar.a.size();
        for (int i2 = 0; i2 < size; i2++) {
            defpackage.nr.b bVar = (defpackage.nr.b) nrVar.a.get(i2);
            int i3 = bVar.a;
            if (i3 != 1) {
                if (i3 != 2) {
                    if (i3 == 8) {
    ...
    public void initAdapterManager() {
        this.mAdapterHelper = new nr(new defpackage.nr.a() {
            private void c(defpackage.nr.b bVar) {
                int i = bVar.a;
                if (i == 1) {
            ...
            public final ViewHolder a(int i) {
                ...
                return (findViewHolderForPosition == null || RecyclerView.this.mChildHelper.d(findViewHolderForPosition.itemView)) ? null : findViewHolderForPosition;
            }
            ...
            public final void a(defpackage.nr.b bVar) {
                c(bVar);
            }
            ...
            public final void b(defpackage.nr.b bVar) {
                c(bVar);
            }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        oi oiVar = new oi(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(R.dimen.fastscroll_margin));
    }
    ...
    public void onDetachedFromWindow() {
        ...
        do {
        } while (defpackage.ox.a.d.a() != null);
        if (ALLOW_THREAD_GAP_WORK) {
            oj ojVar = this.mGapWorker;
            if (ojVar != null) {
                ojVar.b.remove(this);
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        if (!(this.mLayout == null || this.mLayoutFrozen || motionEvent.getAction() != 8)) {
            ...
            if ((motionEvent.getSource() & 2) != 0) {
                f = this.mLayout.canScrollVertically() ? -motionEvent.getAxisValue(9) : MapboxConstants.MINIMUM_ZOOM;
                if (this.mLayout.canScrollHorizontally()) {
                    axisValue = motionEvent.getAxisValue(10);
                    if (!(f == MapboxConstants.MINIMUM_ZOOM && axisValue == MapboxConstants.MINIMUM_ZOOM)) {
            ...
            axisValue = MapboxConstants.MINIMUM_ZOOM;
            scrollByInternal((int) (axisValue * this.mScaledHorizontalScrollFactor), (int) (f * this.mScaledVerticalScrollFactor), motionEvent);
        }
        return false;
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            ...
            if (mode == AudioPlayer.INFINITY_LOOP_COUNT && mode2 == AudioPlayer.INFINITY_LOOP_COUNT) {
                z = true;
            }
            if (!(z || this.mAdapter == null)) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), AudioPlayer.INFINITY_LOOP_COUNT), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), AudioPlayer.INFINITY_LOOP_COUNT));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(i, i2);
                }
    ...
    public void postAnimationRunner() {
        if (!this.mPostedAnimatorRunner && this.mIsAttached) {
            kb.a((View) this, this.mItemAnimatorRunner);
    ...
    public boolean removeAnimatingView(View view) {
        ...
        stopInterceptRequestLayout(i ^ 1);
        return i;
    }
    ...
    public void setAccessibilityDelegateCompat(RecyclerViewAccessibilityDelegate recyclerViewAccessibilityDelegate) {
        ...
        j.a((View) this, this.mAccessibilityDelegate);
    }
    ...
    public void setLayoutFrozen(boolean z) {
        if (z != this.mLayoutFrozen) {
            ...
            if (z) {
                ...
                onTouchEvent(MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, MapboxConstants.MINIMUM_ZOOM, MapboxConstants.MINIMUM_ZOOM, 0));
    ...
    public void setLayoutManager(LayoutManager layoutManager) {
        if (layoutManager != this.mLayout) {
            ...
            for (int size = ogVar.c.size() - 1; size >= 0; size--) {
                ogVar.a.d((View) ogVar.c.get(size));
                ogVar.c.remove(size);
            }
            ogVar.a.b();
    ...
    public void viewRangeUpdate(int i, int i2, Object obj) {
        ...
        for (int i4 = 0; i4 < b; i4++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore() && childViewHolderInt.mPosition >= i && childViewHolderInt.mPosition < i3) {
                ...
                ((LayoutParams) c.getLayoutParams()).mInsetsDirty = true;
            }
        }
