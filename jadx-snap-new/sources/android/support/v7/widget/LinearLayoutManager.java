...
public class LinearLayoutManager extends LayoutManager implements ScrollVectorProvider, ViewDropHandler {
    ...
    static class a {
        ...
        public final void a(View view, int i) {
            ...
            if (this.d) {
                i = (this.a.getEndAfterPadding() - totalSpaceChange) - this.a.getDecoratedEnd(view);
                this.c = this.a.getEndAfterPadding() - i;
                if (i > 0) {
                    decoratedMeasurement = this.c - this.a.getDecoratedMeasurement(view);
                    totalSpaceChange = this.a.getStartAfterPadding();
                    decoratedMeasurement -= totalSpaceChange + Math.min(this.a.getDecoratedStart(view) - totalSpaceChange, 0);
                    if (decoratedMeasurement < 0) {
                        this.c += Math.min(i, -decoratedMeasurement);
                    }
                }
                return;
            }
            i = this.a.getDecoratedStart(view);
            decoratedMeasurement = i - this.a.getStartAfterPadding();
            this.c = i;
            if (decoratedMeasurement > 0) {
                int endAfterPadding = (this.a.getEndAfterPadding() - Math.min(0, (this.a.getEndAfterPadding() - totalSpaceChange) - this.a.getDecoratedEnd(view))) - (i + this.a.getDecoratedMeasurement(view));
                if (endAfterPadding < 0) {
                    this.c -= Math.min(decoratedMeasurement, -endAfterPadding);
                }
            }
        }
    ...
    private boolean updateAnchorFromChildren(Recycler recycler, State state, a aVar) {
        ...
        View findReferenceChildClosestToEnd = aVar.d ? findReferenceChildClosestToEnd(recycler, state) : findReferenceChildClosestToStart(recycler, state);
        ...
        if (!state.isPreLayout() && supportsPredictiveItemAnimations()) {
            ...
            if (z) {
                aVar.c = aVar.d ? this.mOrientationHelper.getEndAfterPadding() : this.mOrientationHelper.getStartAfterPadding();
            }
        }
        return true;
    }
            ...
            if (i != -1) {
                if (i < 0 || i >= state.getItemCount()) {
                    ...
                    if (savedState != null && savedState.hasValidAnchor()) {
                        ...
                        aVar.c = aVar.d ? this.mOrientationHelper.getEndAfterPadding() - this.mPendingSavedState.mAnchorOffset : this.mOrientationHelper.getStartAfterPadding() + this.mPendingSavedState.mAnchorOffset;
                        return true;
                        ...
                        if (findViewByPosition == null) {
                            ...
                            aVar.c = aVar.d ? this.mOrientationHelper.getDecoratedEnd(findViewByPosition) + this.mOrientationHelper.getTotalSpaceChange() : this.mOrientationHelper.getDecoratedStart(findViewByPosition);
                        }
                        return true;
                    } else {
                        boolean z2 = this.mShouldReverseLayout;
                        aVar.d = z2;
                        aVar.c = z2 ? this.mOrientationHelper.getEndAfterPadding() - this.mPendingScrollPositionOffset : this.mOrientationHelper.getStartAfterPadding() + this.mPendingScrollPositionOffset;
                        return true;
                    }
                }
            }
    ...
    public void onLayoutChildren(Recycler recycler, State state) {
        ...
        if (this.mAnchorInfo.d) {
            ...
            bVar = this.mLayoutState;
            bVar.h = extraLayoutSpace;
            fill(recycler, bVar, state, false);
            extraLayoutSpace = this.mLayoutState.b;
            ...
            i = this.mLayoutState.d;
            if (this.mLayoutState.c > 0) {
                extraLayoutSpace += this.mLayoutState.c;
            }
            updateLayoutStateToFillStart(this.mAnchorInfo);
            bVar2 = this.mLayoutState;
            bVar2.h = extraLayoutSpace;
            bVar2.d += this.mLayoutState.e;
            fill(recycler, this.mLayoutState, state, false);
            extraLayoutSpace = this.mLayoutState.b;
            if (this.mLayoutState.c > 0) {
