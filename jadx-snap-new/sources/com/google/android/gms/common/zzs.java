...
public class zzs {
    ...
    private static boolean zzfrr;
    private static boolean zzfrs;
    private static boolean zzfrt;
    private static boolean zzfru;
    ...
    private static int zza(Context context, boolean z, int i, int i2) {
        ...
        try {
            ...
            if (!zzt.zza(packageInfo2, true)) {
                ...
                int i3 = packageInfo2.versionCode / MultiSnapThumbnailTilesViewControllerKt.THUMBNAIL_SELECTED_INTERVAL;
                if (i3 >= i / MultiSnapThumbnailTilesViewControllerKt.THUMBNAIL_SELECTED_INTERVAL || (i2 != -1 && i3 >= i2 / MultiSnapThumbnailTilesViewControllerKt.THUMBNAIL_SELECTED_INTERVAL)) {
                    ...
                    i3 = GOOGLE_PLAY_SERVICES_VERSION_CODE;
