...
public final class zzdc extends fv implements zzcf {
    private static WeakHashMap<FragmentActivity, WeakReference<zzdc>> zzgan = new WeakHashMap();
    private int zzcfl = 0;
    private Map<String, LifecycleCallback> zzgao = new iv();
    ...
    public static zzdc zza(FragmentActivity fragmentActivity) {
        ...
        if (weakReference != null) {
            zzdc zzdc = (zzdc) weakReference.get();
            if (zzdc != null) {
                return zzdc;
            }
        }
        try {
            Object obj = (zzdc) fragmentActivity.b().a(str);
            if (obj == null || obj.isRemoving()) {
                obj = new zzdc();
                fragmentActivity.b().a().a((fv) obj, str).c();
            }
            zzgan.put(fragmentActivity, new WeakReference(obj));
            return obj;
