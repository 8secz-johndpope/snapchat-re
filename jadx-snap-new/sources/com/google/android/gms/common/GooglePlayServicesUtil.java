...
public final class GooglePlayServicesUtil extends zzs {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, fv fvVar, int i2, OnCancelListener onCancelListener) {
        if (zzs.zzd(activity, i)) {
            i = 18;
        }
        ...
        Dialog zza = GoogleApiAvailability.zza((Context) activity, i, zzv.zza(fvVar, zzf.zza(activity, i, "d"), i2), onCancelListener);
        if (zza == null) {
            return false;
        }
