...
public abstract class zzr<T> implements Comparable<zzr<T>> {
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder(((((str2.length() + 3) + String.valueOf(str).length()) + String.valueOf(concat).length()) + String.valueOf(valueOf2).length()) + String.valueOf(valueOf3).length());
