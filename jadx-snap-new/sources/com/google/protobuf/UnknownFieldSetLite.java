...
public final class UnknownFieldSetLite {
    ...
    public final int getSerializedSize() {
        ...
        for (i = 0; i < this.count; i++) {
            ...
            if (i3 == 0) {
                ...
                i3 = (CodedOutputStream.computeTagSize(tagFieldNumber) << 1) + ((UnknownFieldSetLite) this.objects[i]).getSerializedSize();
            } else if (i3 == 5) {
    ...
    /* Access modifiers changed, original: final */
    public final void printWithIndent(StringBuilder stringBuilder, int i) {
