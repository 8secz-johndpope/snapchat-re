...
public final class Internal {
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        class EntryAdapter implements Entry<K, V> {
            ...
            public V setValue(V v) {
                ...
                return value == null ? null : MapAdapter.this.valueConverter.doForward(value);
            }
        }

        class IteratorAdapter implements Iterator<Entry<K, V>> {
        ...
        class SetAdapter extends AbstractSet<Entry<K, V>> {
        ...
        public V get(Object obj) {
            ...
            return obj == null ? null : this.valueConverter.doForward(obj);
        }

        public V put(K k, V v) {
            Object put = this.realMap.put(k, this.valueConverter.doBackward(v));
            return put == null ? null : this.valueConverter.doForward(put);
        }
    }
