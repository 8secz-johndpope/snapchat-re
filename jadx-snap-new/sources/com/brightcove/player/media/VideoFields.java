...
public class VideoFields {
    ...
    public static final String[] DEFAULT_FIELDS = new String[]{ACCOUNT_ID, "name", "shortDescription", "referenceId", "id", "customFields", VIDEO_FULL_LENGTH, HLS_URL, VIDEO_STILL_URL, CUE_POINTS, RENDITIONS, DURATION};
