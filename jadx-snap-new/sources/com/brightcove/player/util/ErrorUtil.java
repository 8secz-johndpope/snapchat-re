...
public class ErrorUtil {
    ...
    public static final String PROJECTION_FORMAT_NOT_SUPPORTED = "projectionFormatNotSupported";
    ...
    static {
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder("Exception in ErrorUtil initializer: ");
