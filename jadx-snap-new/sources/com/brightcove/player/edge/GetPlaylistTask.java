...
public class GetPlaylistTask extends ya implements Component {
    ...
    public void getByReferenceId(String str, PlaylistListener playlistListener) {
        ...
        try {
            ...
            stringBuilder.append("/accounts/");
            stringBuilder.append(this.c);
            stringBuilder.append("/playlists/ref:");
            stringBuilder.append(str);
            execute(new URI[]{new URI(stringBuilder.toString())});
            a(r4);
        } catch (URISyntaxException e) {
    ...
    L_0x004a:
        ...
        goto L_0x009b;
    L_0x0054:
        r7 = r6.a(r7);	 Catch:{ JSONException -> 0x006c, IllegalArgumentException -> 0x005e }
        r0 = r6.f;	 Catch:{ JSONException -> 0x006c, IllegalArgumentException -> 0x005e }
        r0.onPlaylist(r7);	 Catch:{ JSONException -> 0x006c, IllegalArgumentException -> 0x005e }
        goto L_0x009b;
    L_0x005e:
        r7 = move-exception;
