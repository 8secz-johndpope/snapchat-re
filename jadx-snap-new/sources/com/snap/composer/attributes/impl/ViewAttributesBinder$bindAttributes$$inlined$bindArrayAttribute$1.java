...
public final class ViewAttributesBinder$bindAttributes$$inlined$bindArrayAttribute$1 extends UntypedAttributeHandler {
    private /* synthetic */ ViewAttributesBinder a;
    private /* synthetic */ ViewAttributesBinder b;

    public ViewAttributesBinder$bindAttributes$$inlined$bindArrayAttribute$1(ViewAttributesBinder viewAttributesBinder, ViewAttributesBinder viewAttributesBinder2) {
    ...
    public final void applyAttribute(Object obj, Object obj2, Animator animator) {
        if (obj != null) {
            ...
            if (obj2 instanceof Object[]) {
                this.b.applyBackground(view, (Object[]) obj2, composerAnimator);
                return;
            }
    ...
    public final void resetAttribute(Object obj, Animator animator) {
        if (obj != null) {
            ...
            this.a.resetBackground(view, (ComposerAnimator) animator);
            return;
        }
        throw new ajxt("null cannot be cast to non-null type T");
    }
