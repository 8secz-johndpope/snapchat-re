...
public final class EditTextAttributesBinder$bindAttributes$$inlined$bindIntAttribute$1 extends IntAttributeHandler {
    private /* synthetic */ EditTextAttributesBinder a;
    private /* synthetic */ EditTextAttributesBinder b;

    public EditTextAttributesBinder$bindAttributes$$inlined$bindIntAttribute$1(EditTextAttributesBinder editTextAttributesBinder, EditTextAttributesBinder editTextAttributesBinder2) {
    ...
    public final void applyAttribute(Object obj, long j, Animator animator) {
        if (obj != null) {
            ...
            EditTextAttributesBinder.access$applyNumberOfLines(this.a, composerEditText, i, (ComposerAnimator) animator);
            return;
        }
    ...
    public final void resetAttribute(Object obj, Animator animator) {
        if (obj != null) {
            ...
            ComposerEditText composerEditText = (ComposerEditText) view;
            EditTextAttributesBinder.access$resetNumberOfLines(this.b, composerEditText, (ComposerAnimator) animator);
            return;
        }
        throw new ajxt("null cannot be cast to non-null type T");
    }
