...
public final class EditTextAttributesBinder$bindAttributes$$inlined$bindBooleanAttribute$3 extends BooleanAttributeHandler {
    private /* synthetic */ EditTextAttributesBinder a;
    private /* synthetic */ EditTextAttributesBinder b;

    public EditTextAttributesBinder$bindAttributes$$inlined$bindBooleanAttribute$3(EditTextAttributesBinder editTextAttributesBinder, EditTextAttributesBinder editTextAttributesBinder2) {
    ...
    public final void applyAttribute(Object obj, boolean z, Animator animator) {
        if (obj != null) {
            ...
            composerEditText.setHorizontallyScrolling(z);
            return;
        }
    ...
    public final void resetAttribute(Object obj, Animator animator) {
        if (obj != null) {
            ...
            ComposerEditText composerEditText = (ComposerEditText) view;
            composerEditText.setHorizontallyScrolling(true);
            return;
        }
        throw new ajxt("null cannot be cast to non-null type T");
    }
