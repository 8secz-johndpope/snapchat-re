...
public final class TextViewAttributesBinder$bindAttributes$$inlined$bindBooleanAttribute$1 extends BooleanAttributeHandler {
    private /* synthetic */ TextViewAttributesBinder a;
    private /* synthetic */ TextViewAttributesBinder b;

    public TextViewAttributesBinder$bindAttributes$$inlined$bindBooleanAttribute$1(TextViewAttributesBinder textViewAttributesBinder, TextViewAttributesBinder textViewAttributesBinder2) {
    ...
    public final void applyAttribute(Object obj, boolean z, Animator animator) {
        if (obj != null) {
            ...
            this.a.applyIncludeFontPadding(textView, z, (ComposerAnimator) animator);
            return;
        }
    ...
    public final void resetAttribute(Object obj, Animator animator) {
        if (obj != null) {
            ...
            TextView textView = (TextView) view;
            this.b.resetIncludeFontPadding(textView, (ComposerAnimator) animator);
            return;
        }
        throw new ajxt("null cannot be cast to non-null type T");
    }
