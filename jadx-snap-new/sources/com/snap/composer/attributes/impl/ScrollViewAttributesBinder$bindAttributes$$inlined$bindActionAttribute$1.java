...
public final class ScrollViewAttributesBinder$bindAttributes$$inlined$bindActionAttribute$1 extends UntypedAttributeHandler {
    private /* synthetic */ ScrollViewAttributesBinder a;
    private /* synthetic */ ScrollViewAttributesBinder b;

    public ScrollViewAttributesBinder$bindAttributes$$inlined$bindActionAttribute$1(ScrollViewAttributesBinder scrollViewAttributesBinder, ScrollViewAttributesBinder scrollViewAttributesBinder2) {
    ...
    public final void applyAttribute(Object obj, Object obj2, Animator animator) {
        if (obj != null) {
            ...
            if (obj2 instanceof ComposerAction) {
                ...
                this.b.applyOnScroll(composerScrollView, (ComposerAction) obj2);
                return;
                ...
                if (findComposerContext != null) {
                    ...
                    if (actions != null) {
                        ...
                        if (action != null) {
                            this.b.applyOnScroll((ComposerScrollView) view, action);
                            return;
                        }
                    }
                }
    ...
    public final void resetAttribute(Object obj, Animator animator) {
        if (obj != null) {
            this.a.resetOnScroll((ComposerScrollView) ((View) obj));
            return;
        }
        throw new ajxt("null cannot be cast to non-null type T");
    }
