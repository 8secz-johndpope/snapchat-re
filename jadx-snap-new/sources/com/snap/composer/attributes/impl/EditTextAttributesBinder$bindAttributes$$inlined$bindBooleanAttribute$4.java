...
public final class EditTextAttributesBinder$bindAttributes$$inlined$bindBooleanAttribute$4 extends BooleanAttributeHandler {
    private /* synthetic */ EditTextAttributesBinder a;
    private /* synthetic */ EditTextAttributesBinder b;

    public EditTextAttributesBinder$bindAttributes$$inlined$bindBooleanAttribute$4(EditTextAttributesBinder editTextAttributesBinder, EditTextAttributesBinder editTextAttributesBinder2) {
    ...
    public final void applyAttribute(Object obj, boolean z, Animator animator) {
        if (obj != null) {
            ...
            EditTextAttributesBinder.access$applyClosesWhenReturnKeyPressed(this.a, composerEditText, z, (ComposerAnimator) animator);
            return;
        }
    ...
    public final void resetAttribute(Object obj, Animator animator) {
        if (obj != null) {
            ...
            ComposerEditText composerEditText = (ComposerEditText) view;
            EditTextAttributesBinder.access$resetClosesWhenReturnKeyPressed(this.b, composerEditText, (ComposerAnimator) animator);
            return;
        }
        throw new ajxt("null cannot be cast to non-null type T");
    }
