...
public final class ViewAttributesBinder$bindAttributes$$inlined$bindActionAttribute$4 extends UntypedAttributeHandler {
    private /* synthetic */ GestureAttributes a;
    private /* synthetic */ GestureAttributes b;

    public ViewAttributesBinder$bindAttributes$$inlined$bindActionAttribute$4(GestureAttributes gestureAttributes, GestureAttributes gestureAttributes2) {
    ...
    public final void applyAttribute(Object obj, Object obj2, Animator animator) {
        if (obj != null) {
            ...
            if (obj2 instanceof ComposerAction) {
                this.b.applyOnPinch(view, (ComposerAction) obj2);
                return;
                ...
                if (findComposerContext != null) {
                    ...
                    if (actions != null) {
                        ...
                        if (action != null) {
                            this.b.applyOnPinch(view, action);
                            return;
                        }
                    }
                }
