...
public final class EditTextAttributesBinder$bindAttributes$$inlined$bindStringAttribute$3 extends StringAttributeHandler {
    private /* synthetic */ EditTextAttributesBinder a;
    private /* synthetic */ EditTextAttributesBinder b;

    public EditTextAttributesBinder$bindAttributes$$inlined$bindStringAttribute$3(EditTextAttributesBinder editTextAttributesBinder, EditTextAttributesBinder editTextAttributesBinder2) {
    ...
    public final void applyAttribute(Object obj, String str, Animator animator) {
        ...
        if (obj != null) {
            ...
            EditTextAttributesBinder.access$applyReturnKeyText(this.a, composerEditText, str, (ComposerAnimator) animator);
            return;
        }
    ...
    public final void resetAttribute(Object obj, Animator animator) {
        if (obj != null) {
            ...
            ComposerEditText composerEditText = (ComposerEditText) view;
            EditTextAttributesBinder.access$resetReturnKeyText(this.b, composerEditText, (ComposerAnimator) animator);
            return;
        }
        throw new ajxt("null cannot be cast to non-null type T");
    }
