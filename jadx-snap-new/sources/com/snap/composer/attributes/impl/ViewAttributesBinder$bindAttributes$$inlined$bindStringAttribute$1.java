...
public final class ViewAttributesBinder$bindAttributes$$inlined$bindStringAttribute$1 extends StringAttributeHandler {
    private /* synthetic */ ViewAttributesBinder a;
    private /* synthetic */ ViewAttributesBinder b;

    public ViewAttributesBinder$bindAttributes$$inlined$bindStringAttribute$1(ViewAttributesBinder viewAttributesBinder, ViewAttributesBinder viewAttributesBinder2) {
    ...
    public final void applyAttribute(Object obj, String str, Animator animator) {
        ...
        if (obj != null) {
            ...
            ViewAttributesBinder.access$applyAccessibilityId(this.a, view, str, (ComposerAnimator) animator);
            return;
        }
    ...
    public final void resetAttribute(Object obj, Animator animator) {
        if (obj != null) {
            ...
            ViewAttributesBinder.access$resetAccessibilityId(this.b, view, (ComposerAnimator) animator);
            return;
        }
        throw new ajxt("null cannot be cast to non-null type T");
    }
