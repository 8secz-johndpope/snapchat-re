...
public final class ScrollViewAttributesBinder$bindAttributes$$inlined$bindBooleanAttribute$7 extends BooleanAttributeHandler {
    private /* synthetic */ ScrollViewAttributesBinder a;
    private /* synthetic */ ScrollViewAttributesBinder b;

    public ScrollViewAttributesBinder$bindAttributes$$inlined$bindBooleanAttribute$7(ScrollViewAttributesBinder scrollViewAttributesBinder, ScrollViewAttributesBinder scrollViewAttributesBinder2) {
    ...
    public final void applyAttribute(Object obj, boolean z, Animator animator) {
        if (obj != null) {
            ...
            composerScrollView.setAlwaysAllowHorizontalOverflow(z);
            return;
        }
    ...
    public final void resetAttribute(Object obj, Animator animator) {
        if (obj != null) {
            ...
            ComposerScrollView composerScrollView = (ComposerScrollView) view;
            composerScrollView.setAlwaysAllowHorizontalOverflow(false);
            return;
        }
        throw new ajxt("null cannot be cast to non-null type T");
    }
