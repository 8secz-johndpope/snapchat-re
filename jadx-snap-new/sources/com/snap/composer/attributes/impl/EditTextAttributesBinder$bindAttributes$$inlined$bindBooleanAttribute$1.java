...
public final class EditTextAttributesBinder$bindAttributes$$inlined$bindBooleanAttribute$1 extends BooleanAttributeHandler {
    private /* synthetic */ EditTextAttributesBinder a;
    private /* synthetic */ EditTextAttributesBinder b;

    public EditTextAttributesBinder$bindAttributes$$inlined$bindBooleanAttribute$1(EditTextAttributesBinder editTextAttributesBinder, EditTextAttributesBinder editTextAttributesBinder2) {
    ...
    public final void applyAttribute(Object obj, boolean z, Animator animator) {
        if (obj != null) {
            ...
            EditTextAttributesBinder.access$applyFocus(this.a, composerEditText, z, (ComposerAnimator) animator);
            return;
        }
