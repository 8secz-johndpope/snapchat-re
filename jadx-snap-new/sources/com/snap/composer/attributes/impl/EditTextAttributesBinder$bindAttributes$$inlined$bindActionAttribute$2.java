...
public final class EditTextAttributesBinder$bindAttributes$$inlined$bindActionAttribute$2 extends UntypedAttributeHandler {
    private /* synthetic */ EditTextAttributesBinder a;
    private /* synthetic */ EditTextAttributesBinder b;

    public EditTextAttributesBinder$bindAttributes$$inlined$bindActionAttribute$2(EditTextAttributesBinder editTextAttributesBinder, EditTextAttributesBinder editTextAttributesBinder2) {
    ...
    public final void applyAttribute(Object obj, Object obj2, Animator animator) {
        if (obj != null) {
            ...
            if (obj2 instanceof ComposerAction) {
                ...
                composerEditText.setOnEditorActionListener(new a((ComposerAction) obj2));
                return;
                ...
                if (findComposerContext != null) {
                    ...
                    if (actions != null) {
                        ...
                        if (action != null) {
                            ((ComposerEditText) view).setOnEditorActionListener(new a(action));
                            return;
                        }
                    }
                }
