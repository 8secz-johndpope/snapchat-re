...
public final class ViewAttributesBinder$bindAttributes$$inlined$bindActionAttribute$1 extends UntypedAttributeHandler {
    private /* synthetic */ GestureAttributes a;
    private /* synthetic */ GestureAttributes b;

    public ViewAttributesBinder$bindAttributes$$inlined$bindActionAttribute$1(GestureAttributes gestureAttributes, GestureAttributes gestureAttributes2) {
    ...
    public final void applyAttribute(Object obj, Object obj2, Animator animator) {
        if (obj != null) {
            ...
            if (obj2 instanceof ComposerAction) {
                this.b.applyOnTap(view, (ComposerAction) obj2);
                return;
