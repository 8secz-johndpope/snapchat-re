...
public final class ViewAttributesBinder$bindAttributes$$inlined$bindActionAttribute$2 extends UntypedAttributeHandler {
    private /* synthetic */ GestureAttributes a;
    private /* synthetic */ GestureAttributes b;

    public ViewAttributesBinder$bindAttributes$$inlined$bindActionAttribute$2(GestureAttributes gestureAttributes, GestureAttributes gestureAttributes2) {
    ...
    public final void applyAttribute(Object obj, Object obj2, Animator animator) {
        if (obj != null) {
            ...
            if (obj2 instanceof ComposerAction) {
                this.b.applyOnLongPress(view, (ComposerAction) obj2);
                return;
                ...
                if (findComposerContext != null) {
                    ...
                    if (actions != null) {
                        ...
                        if (action != null) {
                            this.b.applyOnLongPress(view, action);
                            return;
                        }
                    }
                }
    ...
    public final void resetAttribute(Object obj, Animator animator) {
        if (obj != null) {
            this.a.resetOnLongPress((View) obj);
            return;
        }
        throw new ajxt("null cannot be cast to non-null type T");
    }
