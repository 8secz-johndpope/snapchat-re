...
public class SQLiteQueryBuilder {
        ...
        if (strArr == null || strArr.length <= 0) {
            ...
            while (i < length) {
                ...
                if (str != null) {
                    ...
                    StringBuilder stringBuilder = new StringBuilder("Invalid column ");
    ...
    public String buildQuery(String[] strArr, String str, String[] strArr2, String str2, String str3, String str4, String str5) {
        ...
        StringBuilder stringBuilder2 = this.mWhereClause;
        Object obj = (stringBuilder2 == null || stringBuilder2.length() <= 0) ? null : 1;
        if (obj != null) {
    ...
    public Cursor query(SQLiteDatabase sQLiteDatabase, String[] strArr, String str, String[] strArr2, String str2, String str3, String str4, String str5) {
        ...
        if (Log.isLoggable(str6, 3)) {
            Log.d(str6, "Performing query: ".concat(String.valueOf(buildQuery)));
        }
